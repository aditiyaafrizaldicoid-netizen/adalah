...
class ChannelConfig:
    ...
    """
    # --- THRUSTER ---
    thruster_left_ch: int = int(os.getenv("CH_THRUSTER_LEFT", "1"))    # Default MAIN 1
    thruster_right_ch: int = int(os.getenv("CH_THRUSTER_RIGHT", "3"))  # Default MAIN 3

    # --- SERVO (Vectored Thrust / Kemudi) ---
    servo_left_ch: int = int(os.getenv("CH_SERVO_LEFT", "2"))          # Default MAIN 2
    servo_right_ch: int = int(os.getenv("CH_SERVO_RIGHT", "4"))        # Default MAIN 4
